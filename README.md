...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-cinderclient-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8279&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-cinderclient-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-cinderclient` can be installed with:

```
conda install python-cinderclient
```

It is possible to list all of the versions of `python-cinderclient` available on your platform with:
