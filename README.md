About python-cinderclient-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-cinderclient-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-cinderclient-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-cinderclient
# for installing globally
pixi global install python-cinderclient
```
...
It is possible to list all of the versions of `python-cinderclient` available on your platform:
...
```
pixi search python-cinderclient --channel conda-forge
```
